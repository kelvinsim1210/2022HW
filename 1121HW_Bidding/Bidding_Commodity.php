<?php
    include "./Update_All_Commodity_Status.php";
...
<body>
    ...
    <?php
        ...
        $Table_innerHTML .= "<tr>";
        $Table_innerHTML .= "<td id='Mandatory_End'>強制結束</td>";
        ...
        for($x=0; $x<count($Datas); $x++) {
            $Table_innerHTML .= "<tr>";
            if($Datas[$x]["Commodity_Seller_Id"] == $_SESSION["User_Id"]) {
                $Table_innerHTML .= "<td class='Mandatory_Btn_Box'>
                    <a href='./Mandatory_Now.php?CId=".$Datas[$x]['Commodity_Id']."'>立刻結束</a>
                </td>";
            }
            else {
                $Table_innerHTML .= "<td></td>";
            }
